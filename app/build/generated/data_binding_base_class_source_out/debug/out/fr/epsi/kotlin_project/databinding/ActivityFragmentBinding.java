...
public final class ActivityFragmentBinding implements ViewBinding {
  ...
  private ActivityFragmentBinding(@NonNull LinearLayout rootView,
      @NonNull RelativeLayout fragmentContainer) {
  ...
  public static ActivityFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFragmentBinding((LinearLayout) rootView, fragmentContainer);
    }
